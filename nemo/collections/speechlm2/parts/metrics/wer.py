...
try:
    ...
    from whisper_normalizer.english import EnglishTextNormalizer as BasicTextNormalizer
...
class WER:
    ...
    By default, uses Whisper's BasicTextNormalizer (multilingual-friendly) on hypotheses and references.
    """
